...
var Sharify = (function () {
    ...
    */
    Sharify.prototype.renderIcons = function () {
        ...
        var sites = this.options.sites, i = 0, len = sites.length, fragment = document.createDocumentFragment(), _shareUrls = this._shareUrls;
        console.log(sites);
        for (; i < len; i++) {
    ...
    */
     ...
     * @param {}
    */
    Sharify.prototype.setUrl = function (name) {
        var key, _shareUrls = this._shareUrls, url = this._shareUrls[name.toLowerCase()];
